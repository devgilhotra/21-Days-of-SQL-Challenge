-- DML Commands - Data Maipulation Language
...
-- instead of using this we use TRINCATE DELETE FROM persons 
...
-- 1) Comparision Operators: compare two things
